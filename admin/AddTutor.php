  ...
  <script>
        function confirmAdd() {
            ...
            if (result) {
                ...
                document.forms["addTutorForm"].submit();
            } else {
        ...
        <div class="col-md-12">
          <div class="card" style="margin-left: -50px;">
            <div class="card-reader">
              <h4>
                Add Tutor
                <a href="TutorAdmin.php" class="btn btn-danger float-end">BACK</a>
              </h4>
            </div>
            <div class="card-body">
              <form action="AddData.php" method="POST" name="addTutorForm">
                  <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" id="T_Password" name="T_Password" class="form-control">
                </div>
                <div class="mb-3">
                  <label>Tutor Address</label>
                  <input type="text" id="T_Address"  name="T_Address" class="form-control">
                </div>
                <div class="mb-3">
                <button type="button" onclick="confirmAdd()" class="btn btn-primary">Save Tutor</button>
              </div>
